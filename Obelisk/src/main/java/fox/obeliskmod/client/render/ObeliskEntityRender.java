...
@OnlyIn(Dist.CLIENT)
public class ObeliskEntityRender extends LivingRenderer<TestEntity, ObeliskEntityModel>
{
	
	public ObeliskEntityRender(EntityRendererManager manager) 
	{
	...
	public static class RenderFactory implements IRenderFactory<TestEntity>
	{
		...
		public EntityRenderer<? super TestEntity> createRenderFor(EntityRendererManager manager) 
		{
			...
			return new ObeliskEntityRender(manager);
		}
